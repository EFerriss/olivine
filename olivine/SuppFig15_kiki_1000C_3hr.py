...
peaklocs = [0, 1, 2, None]
ytxts = [0.1, 0.1, 0.1, 0.1]
percentslows = [92, 97, 97, 94]
...
axes[1][2].legend(loc=1, ncol=2,bbox_to_anchor=[0.9, 0.2],)

for ax in axes[0]:
    labels = ax.get_xticklabels()
    plt.setp(labels, rotation=60)
    
fig.savefig(kiki.thisfolder+'\..\SuppFig15_kiki_1000C_3hr.jpg', 
            dpi=400, format='jpg')    
