...
### but [010] and [001] were switched according to EBSD! 
### All code has been updated to account for that mistake, 
### but the original filenames retain the incorrect labels.
...
length = Kiki_sample.thickness_microns[0]
Kiki_8hr_profileA = Profile(name=name, time_seconds=3600.*8.,
...
Kiki_8hr_profileC = Profile(name=name, time_seconds=3600.*8.,
...
Kiki_8hr_profileB = Profile(name=name, time_seconds=3600.*8.,
...
wb_Kiki_8hr = Block(profiles=[Kiki_8hr_profileA, Kiki_8hr_profileB, 
                         ...
                         time_seconds=3600.*8., celsius=800.,
                         sample=Kiki_sample)
...
length = Kiki_sample.thickness_microns[0]
Kiki_1000C_3hr_profileA = Profile(name=name, time_seconds=3600*3.,
...
Kiki_1000C_3hr_profileC = Profile(name=name, time_seconds=3600.*3.,
...
Kiki_1000C_3hr_profileB = Profile(name=name, time_seconds=3600.*3.,
...
length = Kiki_sample.thickness_microns[0]
Kiki_1000C_6hr_profileA = Profile(name=name, time_seconds=3600.*6.,
...
length = Kiki_sample.thickness_microns[2]
Kiki_1000C_6hr_profileC = Profile(name=name, time_seconds=3600.*6.,
...
length = Kiki_sample.thickness_microns[1]
Kiki_1000C_6hr_profileB = Profile(name=name, time_seconds=3600.*6.,
...
length = Kiki_sample.thickness_microns[0]
Kiki_1000C_7hr_profileA = Profile(name=name, time_seconds=3600.*7.,
...
length = Kiki_sample.thickness_microns[2]
Kiki_1000C_7hr_profileC = Profile(name=name, time_seconds=3600.*7.,
...
name = 'Kilauea Iki olivine heated 6hr at 1000$\degree$C || b'
length = Kiki_sample.thickness_microns[1]
Kiki_1000C_7hr_profileB = Profile(name=name, time_seconds=3600.*7.,
...
length = Kiki_sample.thickness_microns[0]
Kiki_ox_1000C_1hr_profileA = Profile(name=name, time_seconds=3600.*8.,
...
length = Kiki_sample.thickness_microns[2]
Kiki_ox_1000C_1hr_profileC = Profile(name=name, time_seconds=3600.*8.,
...
length = Kiki_sample.thickness_microns[1]
Kiki_ox_1000C_1hr_profileB = Profile(name=name, time_seconds=3600.*8.,
