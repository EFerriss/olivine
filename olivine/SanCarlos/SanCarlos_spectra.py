...
wb_800C_1hr = Block(name='SC1-2 800C 1hr',
                         ...
                         time_seconds=1.*3600., celsius=800.)
...
wb_800C_3hr = Block(name='SC1-2 800C 3hr',
                                ...
                                time_seconds=3.*3600., celsius=800.)
...
wb_800C_7hr = Block(name='SC1-2 800C 7hr',
                                ...
                                time_seconds=7.*3600., celsius=800.)
...
wb_800C_13hr = Block(name='SC1-2 800C 13hr',
                                ...
                                time_seconds=13.*3600., celsius=800.)
...
wb_1000C_SC1_7 = Block(profiles=[SC1_7_hyd_profileA,
                                             SC1_7_hyd_profileB,
                                             SC1_7_hyd_profileC],
                                   time_seconds=7.*3600., celsius=1000.,
...
wb_800C_19hr = Block(name='SC1-2 800C 19hr',
                                ...
                                time_seconds=19.*3600., celsius=800.)
...
wb_800C_43hr = Block(name='SC1-2 800C 43hr',
                                ...
                                time_seconds=43.*3600., celsius=800.)
...
wb_800C_68hr = Block(name='SC1-2 800C 68hr',
                                ...
                                time_seconds=68.*3600., celsius=800.
                                )
...
wb_800C_hyd.style = {'color':'#2ca02c', 'marker':'o', 'linestyle': 'none', 
                     'markersize':8, 'label': 'hydrated', 'alpha':0.5,}
wb_800C_1hr.style = {'color':'r', 'marker':'+', 'linestyle':'none', 
                     'markersize':9, 'markeredgewidth':2, 'label':'1 hour'}
...
wb_1000C_SC1_7.style = {'color':'#ff7f0e', 'marker':'s', 'linestyle': 'none', 
                        'markersize':6, 'alpha':0.5, 
                        'label':wb_1000C_SC1_7.name}