...
Dehydration profiles for San Carlos olivine SC1-2 after 1 hour
...
styledata = {'color':'k', 'marker':'+', 'linestyle':'none', 'markersize':6,
             'markeredgewidth':1.5}
style68 = {'color':'b', 'marker':'s', 'linestyle':'none', 'markersize':3,
             'markeredgewidth':1}
...
wb1.plot_areas_3panels(axes3=axes[idx], styles3=[styledata]*3,
                       centered=True, show_errorbars=False)
wb68.plot_areas_3panels(axes3=axes[idx], styles3=[style68]*3,
                       centered=True, show_errorbars=False)
...
# diffusion curves
#for init, ax3 in zip(initials, axes):
#    wb1.plot_diffusion(log10D_m2s=fastdiffusion, show_data=False, 
#                       wholeblock_diffusion=True, show_line_at_1=False,
#                       init=init, axes3=ax3, labelD=False)

fig.suptitle('SC1-2 dehydrated 1 hour')
fig.savefig(SC.thisfolder+'\..\SuppFig4_SC_dehyd_1hr.jpg', 
            dpi=300, format='jpg')        
